      ...
      MuiCssBaseline: {
        styleOverrides: {
          ...
          "& a": {
            ...
            ":not(.nav-button, .footer-link, .tooltip-link)": {
              textDecorationColor: appColors.primary + " !important",
              fontSize: increasedAccessibility ? "19px!important" : "inherit",
              fontWeight: increasedAccessibility ? "bold!important" : "inherit",
              "& *:not(.nav-button, .footer-link, .tooltip-link))": {
                fontSize: increasedAccessibility ? "19px!important" : "inherit",
                fontWeight: increasedAccessibility
                  ? "bold!important"
                  : "inherit",
              },
            },
            "&:hover:not(.MuiButton-root, .MuiListItem-root &, .MuiListItemButton-root &, .footer-link)":
              {
                color: appColors.tertiary.dark,
                textDecorationColor: appColors.tertiary.dark,
              },
            "&:focus-visible:not(.MuiButton-root, .MuiListItem-root &, .MuiListItemButton-root &)":
              {
                backgroundColor: appColors.ui_rag["Amber.400"],
                outline: `4px solid ${appColors.primary}`,
                outlineStyle: "double",
                textDecorationColor: appColors.essential[1000] + " !important",

                "*": {
                  color: appColors.essential[1000],
                },
              },
          },
          "& button-visible, a.MuiButton-root:focus-visible": {
            border: "none",
            outlineOffset: "-1px",
        ...
        styleOverrides: {
          ...
          contained: {
            ...
            "&.disabled": {
              ...
              textDecorationColor: appColors.incidental["000"] + " !important",
            ...
            "&.PrimaryDarkBG": {
              ...
              "&.disabled": {
                color: appColors.incidental["000"] + " !important",
                textDecorationColor:
                  appColors.incidental["000"] + " !important",
                background: appColors.grey + " !important",
                cursor: "not-allowed",
                boxShadow: "unset !important",
            ...
            "&.Success": {
              color: "text.primary",
              backgroundColor: appColors.ui_rag["Green.400"],
              ".button-icon": {
                backgroundColor: appColors.incidental["000"],
              },
              "&:hover, &:active, &.loading": {
          ...
          outlined: {
            ...
            "&.disabled": {
              ...
              textDecorationColor: appColors.grey + " !important",
        ...
        styleOverrides: {
          root: {
            ...
            "&:disabled": {
              ...
              textDecorationColor: appColors.essential[500],
              cursor: "not-allowed",
              svg: {
