...
const DefaultHeader: React.FC<HeaderProps<{}>> = ({ column }) => (
  <>{column.id.startsWith("-") ? null : column.id}</>
);
          ...
          Header: ({ getToggleAllPageRowsSelectedProps }: HeaderProps<T>) => (
            <Grid container alignItems="center" wrap="nowrap">
              ...
              {!!additionalFilterValues?.length && (
                <Grid>
                  <IconButton
                    onClick={handleAdditionalFilterClick}
    ...
    <>
      ...
      {additionalFilterColumn && (
        <AdditionalFiltersMenu
          ...
          onClose={handleAdditionalFilterClose}
