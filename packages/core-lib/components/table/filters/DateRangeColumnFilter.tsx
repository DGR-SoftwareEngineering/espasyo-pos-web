  ...
  return (
    <>
      ...
      >
        <Box width={650} p={4}>
          <CustomCalendar
            ...
            nextAriaLabel={"next-month-aria-label"}
            next2AriaLabel={"next-year-aria-label"}
            prevLabel={<KeyboardArrowLeft />}
            prev2Label={<KeyboardDoubleArrowLeft />}
            prevAriaLabel={"previous-month-aria-label"}
            prev2AriaLabel={"previous-year-aria-label"}
          />
        </Box>
      </Popover>
      ...
      <TextField
        ...
        inputProps={{ placeholder: "Select a date range" }}
        InputProps={{
          endAdornment: (
